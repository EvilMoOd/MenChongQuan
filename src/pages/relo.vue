<script lang="ts" setup>
  ...
  import userUserStore from '../store/modules/userStore';
    ...
    <div class="container">
      <div class="welcome">
        <div class="pinkbox" :class="{ toRight: isActive }">
          ...
          <div class="signup" :class="{ nodisplay: isActive }">
            ...
            <form autocomplete="off">
              <input type="text" placeholder="Username" v-model="user.userNameR" />
              <input type="email" placeholder="Email" v-model="user.email" />
              <input type="password" placeholder="Password" v-model="user.passwordR" />
              <input
                type="password"
                placeholder="Confirm Password"
                v-model="user.confirmPassword"
              />
              <button class="button submit" @click="register">Create Account</button>
            </form>
          </div>
        ...
        <div class="leftbox">
          ...
          <img class="flower smaller" src="../assets/images/f1.webp" />
        ...
        <div class="rightbox">
          ...
          <img class="flower" src="../assets/images/f2.webp" />
